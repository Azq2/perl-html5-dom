...
Example:
 ...
 print $tree->html;                         # <div id="test">some <b>bold</b> test</div>
 print $tree->createComment('test')->html;  # <!-- test -->
 print $tree->createTextNode('test')->html; # test
...
Example:
 ...
 my $tree = HTML5::DOM->new->parse('<div id="test">some <b>bold</b> test</div>');
 print $tree->html;                         # some <b>bold</b> test
 print $tree->createComment('test')->html;  # <!-- test -->
 print $tree->createTextNode('test')->html; # test
...
Example:
 ...
 my $tree = HTML5::DOM->new->parse('<div id="test">some <b>bold</b> test</div>');
 print $tree->at('#test')->html('<i>italic</i>');
